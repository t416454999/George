...
REPOS = [
    ('Cursor', 'getcursor/cursor', 'AI 原生代码编辑器，基于 VS Code 深度集成 Claude 和 GPT 模型，支持自然语言编程和多文件重构。'),
    ...
    ('v0 by Vercel', 'vercel/ai', 'Vercel 推出的 AI 驱动 UI 生成工具，输入提示词即可生成可直接部署的前端代码。支持 React、Next.js、Tailwind。'),
...
def main():
    ...
    for name, repo, desc in REPOS:
        ...
        time.sleep(0.5)  # 避免 GitHub API 限速
